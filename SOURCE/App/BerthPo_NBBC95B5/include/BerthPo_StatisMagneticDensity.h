...
uint8_t BerthPo_BottomTimesAdjustStatisProcess(PRM3100_SAMPLE_DATA pRm3100SampleData, PSENSOR_RM3100 pSensorRm3100, PRM3100_MAGNETIC rm3100Magnetic);   //有车且无车时统计实现
